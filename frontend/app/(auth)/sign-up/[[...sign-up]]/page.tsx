    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4 relative">
      ...
      <div className="relative w-full max-w-md flex flex-col items-center gap-6 z-10">
        <div className="flex flex-col items-center gap-2">
          <div className="h-12 w-12 rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 flex items-center justify-center shadow-md shadow-indigo-500/10">
        ...
        <SignUp
          appearance={{
            elements: {
              card: "bg-white border border-slate-200 shadow-xl rounded-2xl text-slate-800",
              ...
              formButtonPrimary: "bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:opacity-95 text-white font-medium rounded-xl transition-all duration-200 shadow-md shadow-indigo-600/10 cursor-pointer",
              ...
              footerActionLink: "text-indigo-600 hover:text-indigo-700 font-medium transition-all"
            }
          }}
        />
      </div>
